...
You can compare the ratio of revisited users upon installing the game per channel and country.   
Comparing the revisit rate according to the marketing channel and country enables you to quantitatively measure the visit effect.  

**(1) Indicator Analysis Guide**    
* Comparing the Retention per channel and country, you can check the channel and nation with high retention rate.
...
![ Channel and Country-Specific Retention Rate]

[ Channel and Country-Specific Retention Rate]


###2) ARPU Comparison  
You can compare the ARPU of revisited users upon installing the game per channel and country.  
Comparing the ARPU of each marketing channel and country enables you to quantitatively measure the effect from the revenue.  

**(1) Indicator Analysis Guide**    
* Comparing the ARPU per channel and country, you can check the channel and nation with high revenue.  
* Comparing the ARPU per channel and country, you can check the channel and nation with high revenue efficiency.  
* The calculation will be based on the selected targets through referrer channel and filter.  
...
![ ARPU Comparison Chart per Channel/Country]
...
You can compare the ratio of level funnel according to channel and country.  
Comparing the level funnel according to the marketing channel and country enables you to quantitatively measure the effect from the level achievement.  

**(1) Indicator Analysis Guide**    
* You can check the channel and country with high revisit rate by comparing the channel/country-specific ARPU.
* You can check the channel and nation with high game usage by comparing the level funnel per channel and nation.
* The calculation will be based on the selected targets through referrer channel and filter.
* The level funnel of maximum 5 channels can be compared, including the natural acquisition.     

![ Level Funnel Comparison Chart per Channel/Country]
