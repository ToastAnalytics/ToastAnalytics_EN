...
This document explains the method to implement Analytics SDK on Android. In order to utilize Analytics SDK, one should register for an app. To register, refer to the link (<http://docs.cloud.toast.com/ko/Analytics/App%20Analytics/Getting%20Started/#_4>).
...
“App ID” and “Company ID” that are issued after registering for the app are necessarily needed to use SDK. As for the way to register for the app, refer to the link (http://docs.cloud.toast.com/ko/Analytics/App%20Analytics/Getting%20Started/#_4)
...
#### 2. Campaign Listener implementation and registration
...
|launchPromotionPage|Excute promotion page. (Android)|
